...
params['cp2k_exe'] = '/home/resh000319/bin/cp2k.sh'
...
params['lowest_orbital'] = 60-45
params['highest_orbital'] = 61+45
...
params['trajectory_xyz_filename'] = path + '/../dynamics_ffMD-aligned.xyz'
